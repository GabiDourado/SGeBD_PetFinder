...
namespace ProjetoSemestre3___Encontrar.Controllers
{
    public class ObservacoesController : Controller
    {
        ...
        {
            ViewData["AnimaisId"] = new SelectList(_context.Animais, "AnimaisId", "AnimalNome");
        ...
        public async Task<IActionResult> Create([Bind("ObservacoesId,ObservacaoDescricao,ObservacaoLocal,ObservacaoData,AnimaisId,UsuarioId")] Observacoes observacoes)
        {
            ...
            ViewData["AnimaisId"] = new SelectList(_context.Animais, "AnimaisId", "AnimalNome", observacoes.AnimaisId);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ObservacoesId,ObservacaoDescricao,ObservacaoLocal,ObservacaoData,AnimaisId,UsuarioId")] Observacoes observacoes)
        {
