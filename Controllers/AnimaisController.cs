...
namespace ProjetoSemestre3___Encontrar.Controllers
{
    public class AnimaisController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("AnimaisId,AnimalNome,AnimalRaça,AnimalTipo,AnimalCor,AnimalSexo,AnimalObservacao,AnimalFoto,AnimalDtDesaparecimento,AnimalDtEncontro,AnimalStatus,UsuarioId")] Animais animais)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("AnimaisId,AnimalNome,AnimalRaça,AnimalTipo,AnimalCor,AnimalSexo,AnimalObservacao,AnimalFoto,AnimalDtDesaparecimento,AnimalDtEncontro,AnimalStatus,UsuarioId")] Animais animais)
        {
